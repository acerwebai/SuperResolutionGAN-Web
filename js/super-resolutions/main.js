...
const srgan_256_4 = {
  modelName: 'SRGAN 256x4',
  inputSize: [256, 256, 3],
  outputSize: [1024, 1024, 3],
  scale: 4,
  modelFile: './model/srgan_256_4.tflite'
};

const srgan_512_4 = {
  modelName: 'SRGAN 512x4',
  inputSize: [512, 512, 3],
  outputSize: [2048, 2048, 3],
  scale: 4,
  modelFile: './model/srgan_512_4.tflite'
};

const srgan_480_4 = {
  modelName: 'SRGAN 480x4',
  inputSize: [480, 480, 3],
  outputSize: [1920, 1920, 3],
  scale: 4,
  modelFile: './model/srgan_480_4.tflite'
};

const srgan_120_90_4 = {
  modelName: 'SRGAN 120_90x4',
  inputSize: [90, 120, 3],
  outputSize: [360, 480, 3],
  scale: 4,
  modelFile: './model/srgan_120_90_4.tflite'
};
...
const srgan_200_150_4 = {
  ...
  scale: 4,
  modelFile: './model/srgan_200_150_4.tflite'
};

const srgan_320_180_4 = {
  modelName: 'SRGAN 320_180x4',
  inputSize: [180, 320, 3],
  outputSize: [720, 1280, 3],
  scale: 4,
  modelFile: './model/srgan_320_180_4.tflite'
};
...
const srgan_480_270_4 = {
  ...
  scale: 4,
  modelFile: './model/srgan_480_270_4.tflite'
};
